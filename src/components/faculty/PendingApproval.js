...
import { getStudentsEnrolledActivity } from "../../actions/facultyActivityAction";
...
class PendingApproval extends Component {
  ...
  render() {
    ...
    //console.log(pendingEnrollStudent);
    //const tp = pendingEnrollStudent;
    //console.log(tp.categoryId);
      ...
      Students.map((student) => (
        <tr>
          ...
          <td>
            ...
            <button className="btn btn-danger mr-1">Reject</button>
          </td>
        </tr>
      ));
